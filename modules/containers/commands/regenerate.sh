...
then
    ...
    # mkrootfs_fedora_base apache "mc httpd mod_ssl openssl unzip rsync"
    # mkrootfs_fedora_base codepad "mc httpd mod_ssl openssl postfix mailx sendmail unzip rsync dovecot gzip git-core curl python openssl-devel postgresql-devel wget mariadb-server ShellCheck"
