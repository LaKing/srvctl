...
##
##   modules/opendkim/hooks/version.sh — report installed version.
##
##   Would print the installed opendkim package version via
...
##   nodejs. The same dead pattern exists in the named, perdition,
...
msg_version_installed opendkim
