...
err "ATTENTION THE SRVCTL3 POUND MODULE IS NOT ACTIVELY MAINTAINED, AND ONLY A LEGACY OPTION!"
err "THE CONFIGURATION SHEME OF THE SRVCTL POUND MODULE IS OUTDATED!"
